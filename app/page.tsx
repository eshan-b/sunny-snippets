...
import { NewsArticle, getNewsArticles } from "@/utils/news-api";
...
const Home = () => {
	const newsArticles = [
		...
		{
			title: "Commodities Carriers Star Bulk and Eagle Bulk Shipping Agree to $2.1 Billion Merger",
			description:
	...
	// TODO: https://nextjs.org/docs/app/building-your-application/data-fetching/fetching-caching-and-revalidating#fetching-data-on-the-server-with-fetch
